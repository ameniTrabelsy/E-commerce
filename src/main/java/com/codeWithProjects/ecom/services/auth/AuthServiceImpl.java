...
import com.codeWithProjects.ecom.config.SecurityConfig;
...
public class AuthServiceImpl implements AuthService {
    ...
    public UserDto createUser(SignupRequest signupRequest){
           ...
           userDto.setId(createdUser.getId());  // id generate auto par DB donc on fait le stocke de user puis on recupere le id
