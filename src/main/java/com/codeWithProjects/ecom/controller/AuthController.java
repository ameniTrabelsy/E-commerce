...
import com.codeWithProjects.ecom.services.auth.AuthServiceImpl;
...
public class AuthController {
    ...
    public void createAuthenticationToken(@RequestBody AuthenticationRequest authenticationRequest, HttpServletResponse response) throws IOException, JSONException {
        ...
        final UserDetails userDetails = userDetailsService.loadUserByUsername(authenticationRequest.getUsername()); // pour recuprer les details depuis DB
        Optional<User> optionalUser = userRepository.findFirstByEmail(userDetails.getUsername()); // obtenir user pour generat token
